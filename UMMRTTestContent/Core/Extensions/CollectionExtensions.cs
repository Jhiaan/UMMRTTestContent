...
namespace UMMRTTestContent.Core.Extensions
{
    /// <summary>
    /// Collection of extentions for interacting with normal C# collections.
    /// <remarks>Copied from <see href="https://github.com/Vek17/TabletopTweaks-Core"/>TabletopTweaks-Core</remarks>
    /// </summary>
    public static class CollectionExtentions
    {
        ...
        /// New array with the additional values appended to the end of it.
        /// </returns>
        public static T[] AppendToArray<T>(this T[] array, IEnumerable<T> values) => array.AppendToArray(values.ToArray());
        /// <summary>
